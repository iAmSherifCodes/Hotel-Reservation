...
# TODO
#  Make response return a list of reservation

class FindReservationByCustomerEmailResponse:
    ...
    # def __init__(self):
    #     self._customer_reservations: list[Reservation] = []
    #
    # def get_customer_reservations(self) -> list[Reservation]:
    #     return self._customer_reservations
    #
    # def set_customer_reservations(self, reservation: Reservation):
    #     self._customer_reservations.append(reservation)
    #
    # def __repr__(self):
    #             return f"""
    #     ---Reservation---
